...
@section('konten')
    <div class="row">
        <div class="col-xl-10 mx-auto">
            ...
            @endif
            <h6 class="mb-0 text-uppercase">Edit Peran</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                    <form method="POST"action="{{ route('peran.update', $data->uuid) }}">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li
                                                    ...
                                                    <span><input type="checkbox" class="check" name="check1[]"
                                                            value="{{ $tipe1->uuid }}"
                                                            @if (is_array($permission) && in_array($tipe1->uuid, $permission)) checked @endif></span>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="card-body">
                                                    ...
                                                    @if ($tipe1->uuid == $tipe2->parent)
                                                        <li
                                                            ...
                                                            {{ $tipe2->name }} <span><input type="checkbox" name="akses[]"
                                                                    ...
                                                                    @if (is_array($permission) && in_array($tipe2->uuid, $permission)) checked @endif></span>
                                                        </li>
                                                    @endif
                                                @endforeach
                                            </ul>
