                    ...
                    <form action="{{ route('user.update', $data->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group" id="show_hide_password_lama">
                                <input type="password" class="form-control border-end-0" id="password_lama"
                                    placeholder="Silahkan isi password lama" name="password_lama"> <a href="javascript:;"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group" id="show_hide_password">
                                <input type="password" class="form-control border-end-0" id="password"
                                    placeholder="Silahkan isi password baru" name="password"> <a href="javascript:;"
                                    class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
                            </div>
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <select class="form-select @error('kd_skpd') is-invalid @enderror select_option" name="kd_skpd"
                                ...
                                @foreach ($kd_skpd as $skpd)
                                    <option value="{{ $skpd->kd_skpd }}"
                                        {{ $data->kd_skpd == $skpd->kd_skpd ? 'selected' : '' }}>{{ $skpd->nm_skpd }}
                                    </option>
                                @endforeach
                            </select>
                            @error('kd_skpd')
