...
@section('konten')
    <div class="row">
        <div class="col-xl-10 mx-auto">
            ...
            @endif
            <h6 class="mb-0 text-uppercase">Ubah Kontrak Adendum</h6>
            <hr />
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6">
                            ...
                            <input class="form-control" type="date" id="tgl_kontrak"
                                value="{{ $dataKontrak->tanggalkontrak }}">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <select class="form-select select_option" id="rekanan">
                                ...
                                @foreach ($daftar_rekening as $rekening)
                                    <option value="{{ $rekening->nmrekan }}" data-rekening="{{ $rekening->rekening }}"
                                        ...
                                        {{ $dataKontrak->rekanan == $rekening->nmrekan ? 'selected' : '' }}>
                                        {{ $rekening->nmrekan }} |
                    ...
                    <div class="row mb-3">
                        <div class="col-6">
                            ...
                            <input class="form-control" type="text" id="pimpinan" placeholder="Isi dengan nama pimpinan"
                                readonly disabled value="{{ $dataKontrak->pimpinan }}">
                        </div>
                        <div class="col-1">
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <select class="form-select select_option" id="metode">
                                <option value="" selected disabled>Silahkan Pilih</option>
                                <option value="1" {{ $dataKontrak->metodepengadaan == 1 ? 'selected' : '' }}>
                                    Kontraktual
                                </option>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <select class="form-select select_option" id="pembayaran">
                                <option value="" selected disabled>Silahkan Pilih</option>
                                <option value="1" {{ $dataKontrak->carapembayaran == '1' ? 'selected' : '' }}>
                                    Sekaligus</option>
                                <option value="2" {{ $dataKontrak->carapembayaran == '2' ? 'selected' : '' }}>
                                    Bertahap</option>
                                <option value="3" {{ $dataKontrak->carapembayaran == '3' ? 'selected' : '' }}>Termin
                                </option>
                            </select>
                        </div>
                    </div>
...
@endsection
@push('js')
    @include('kontrak_adendum.js.edit')
@endpush
