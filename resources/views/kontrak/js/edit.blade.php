...
<script>
    $(document).ready(function() {
        ...
        // CEK KONTRAK SUDAH ADENDUM
        let cekAdendum = "{{ $cekKontrakAdendum }}"
        let cekBast = "{{ $cekBast }}"
        ...
        let rincian_kontrak = $('#rincian_kontrak').DataTable({
            ...
            aoColumns: [{
                ...
                },
                {
                    data: 'aksi',
                    nama: 'aksi',
                    visible: (cekAdendum == 0 && cekBast == 0) ? true : false
                }
            ],
        ...
        $('#simpan_rincian').on('click', function() {
            ...
            if (harga < harga_nego) {
                swalAlert('Harga nego melebihi harga di DPA!');
                return;
            }
